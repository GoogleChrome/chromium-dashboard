...
export function GateToJSON(value?: Gate | null): any {
    ...
    return {
        ...
        'state': value['state'],
        'requested_on': value['requested_on'] == null ? undefined : ((value['requested_on']).toISOString().substring(0,10)),
        'responded_on': value['responded_on'] == null ? undefined : ((value['responded_on']).toISOString().substring(0,10)),
