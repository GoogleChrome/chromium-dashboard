...
class TestDefaultController(BaseTestCase):
    ...
    def test_set_assignees_for_gate(self):
        ...
        """
        patch_gate_request = {"assignees":["assignees","assignees"],"survey_answers":{"launch_or_contact":"launch_or_contact","adoption_mdn_drafted":True,"covers_existence":True,"covers_integration":True,"adoption_fields_up_to_date":True,"explanation":"explanation","adoption_mwg_drafted":True,"is_language_polyfill":True,"covers_errors":True,"adoption_style_aligned":True,"is_api_polyfill":True,"covers_common_cases":True,"adoption_lead_time":True,"is_same_origin_css":True,"covers_invalidation":True}}
        headers = { 
            'Accept': 'application/json',
            'Content-Type': 'application/json',
        }
