...
FIELDINFOVALUE_ANY_OF_SCHEMAS = ["List[str]", "bool", "int", "str"]

class FieldInfoValue(BaseModel):
    """
    FieldInfoValue
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = FieldInfoValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FieldInfoValue with anyOf schemas: List[str], bool, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FieldInfoValue with anyOf schemas: List[str], bool, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
