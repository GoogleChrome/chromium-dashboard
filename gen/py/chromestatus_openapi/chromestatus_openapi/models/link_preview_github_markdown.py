...
class LinkPreviewGithubMarkdown(BaseModel):
    """
    LinkPreviewGithubMarkdown
    """ # noqa: E501
    url: StrictStr
    type: StrictStr
    information: Optional[LinkPreviewGithubMarkdownAllOfInformation] = None
    http_error_code: Optional[StrictInt] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if http_error_code (nullable) is None
        # and model_fields_set contains the field
        if self.http_error_code is None and "http_error_code" in self.model_fields_set:
            _dict['http_error_code'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "url": obj.get("url"),
            "type": obj.get("type"),
            "information": LinkPreviewGithubMarkdownAllOfInformation.from_dict(obj["information"]) if obj.get("information") is not None else None,
