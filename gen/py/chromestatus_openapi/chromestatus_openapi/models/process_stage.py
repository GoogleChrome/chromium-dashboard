...
from chromestatus_openapi.models.process_stage_progress_items_inner import ProcessStageProgressItemsInner  # noqa: E501
...
class ProcessStage(Model):
    ...
    def __init__(self, name=None, description=None, progress_items=None, actions=None, approvals=None, incoming_stage=None, outgoing_stage=None, stage_type=None):  # noqa: E501
        ...
        :type progress_items: List[ProcessStageProgressItemsInner]
        ...
        self.openapi_types = {
            'name': str,
            'description': str,
            'progress_items': List[ProcessStageProgressItemsInner],
            'actions': List[Action],
    ...
    @property
    def progress_items(self) -> List[ProcessStageProgressItemsInner]:
        """Gets the progress_items of this ProcessStage.


        :return: The progress_items of this ProcessStage.
        :rtype: List[ProcessStageProgressItemsInner]
        """
        return self._progress_items

    @progress_items.setter
    def progress_items(self, progress_items: List[ProcessStageProgressItemsInner]):
