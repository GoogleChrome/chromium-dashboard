...
class Process(BaseModel):
    ...
    applicability: Optional[StrictStr] = None
    stages: Optional[List[ProcessStage]] = None
    __properties: ClassVar[List[str]] = ["name", "description", "applicability", "stages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stages": [ProcessStage.from_dict(_item) for _item in obj["stages"]] if obj.get("stages") is not None else None
        })
        return _obj
