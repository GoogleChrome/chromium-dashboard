...
from chromestatus_openapi.models.field_info_value import FieldInfoValue  # noqa: E501
...
class FieldInfo(Model):
    ...
    @value.setter
    def value(self, value: FieldInfoValue):
