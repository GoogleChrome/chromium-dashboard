...
class CreateAccountRequest(BaseModel):
    ...
    is_site_editor: Optional[StrictBool] = Field(default=None, alias="isSiteEditor")
    __properties: ClassVar[List[str]] = ["email", "isAdmin", "isSiteEditor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isSiteEditor": obj.get("isSiteEditor")
        })
        return _obj
