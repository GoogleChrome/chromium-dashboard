...
class ComponentUsersRequest(BaseModel):
    """
    Traits about the user in relation to the component
    """ # noqa: E501
    owner: Optional[StrictBool] = Field(default=None, description="Impacts this user's ownership. For PUT, add ownership. For DELETE, remove ownership.")
