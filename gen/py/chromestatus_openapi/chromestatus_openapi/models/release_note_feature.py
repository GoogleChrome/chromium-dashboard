...
class ReleaseNoteFeature(Model):
    ...
    def summary_source(self) -> str:
        ...
        Source provenance of the feature summary text returned in this release note: - AI_APPLIED: An AI summary suggestion was generated and explicitly approved (SummarySuggestion.status == APPLIED). - HUMAN: Manually authored summary from FeatureEntry. Used when no AI suggestion exists, or when the AI suggestion is PENDING, REJECTED, DISCARDED, or BYPASSED. Note: Derived per-feature at request time to eliminate extra provenance lookups in client UIs.   # noqa: E501
