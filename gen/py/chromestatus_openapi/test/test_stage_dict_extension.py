...
class TestStageDictExtension(unittest.TestCase):
    """StageDictExtension unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StageDictExtension:
        """Test StageDictExtension
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StageDictExtension`
        """
        model = StageDictExtension()
        if include_optional:
            return StageDictExtension(
                id = 56,
    ...
    def testStageDictExtension(self):
        """Test StageDictExtension"""
