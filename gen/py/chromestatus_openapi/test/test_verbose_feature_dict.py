...
class TestVerboseFeatureDict(unittest.TestCase):
    """VerboseFeatureDict unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerboseFeatureDict:
        """Test VerboseFeatureDict
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerboseFeatureDict`
        """
        model = VerboseFeatureDict()
        if include_optional:
            return VerboseFeatureDict(
                id = 56,
    ...
    def testVerboseFeatureDict(self):
        """Test VerboseFeatureDict"""
