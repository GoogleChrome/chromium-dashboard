...
class BrowserUsage(BaseModel):
    ...
    BrowserUsage
    """ # noqa: E501
    chromium: Optional[ChromiumUsageInfo] = None
    __properties: ClassVar[List[str]] = ["chromium"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of chromium
        if self.chromium:
            _dict['chromium'] = self.chromium.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chromium": ChromiumUsageInfo.from_dict(obj["chromium"]) if obj.get("chromium") is not None else None
        })
        return _obj
