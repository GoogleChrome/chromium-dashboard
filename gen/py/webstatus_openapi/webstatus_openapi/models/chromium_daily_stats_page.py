...
class ChromiumDailyStatsPage(BaseModel):
    """
    ChromiumDailyStatsPage
    """ # noqa: E501
    metadata: Optional[PageMetadata] = None
    data: List[ChromiumUsageStat]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ChromiumUsageStat.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
