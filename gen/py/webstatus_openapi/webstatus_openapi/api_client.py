...
from webstatus_openapi.api_response import ApiResponse, T as ApiResponseT
import webstatus_openapi.models
from webstatus_openapi import rest
from webstatus_openapi.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(webstatus_openapi.models, klass)
