...
class TestCanIUseItem(unittest.TestCase):
    """CanIUseItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CanIUseItem:
        """Test CanIUseItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CanIUseItem`
        """
        model = CanIUseItem()
        if include_optional:
            return CanIUseItem(
