...
class TestBrowserImplementation(unittest.TestCase):
    """BrowserImplementation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrowserImplementation:
        """Test BrowserImplementation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrowserImplementation`
        """
        model = BrowserImplementation()
        if include_optional:
    ...
    def testBrowserImplementation(self):
        """Test BrowserImplementation"""
