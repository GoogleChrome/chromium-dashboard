...
BLINK_PROCESS_STAGES = [
  ...
  ProcessStage(
      ...
      ['Request to migrate incubation',  # TODO(jrobbins): needs detector.
...
PSA_ONLY_STAGES = [
  ...
  ProcessStage(
      ...
      ['Web facing PSA email',  # TODO(jrobbins): needs detector.
       'Updated target milestone',  # TODO(jrobbins): needs detector.
       'Intent to Ship email',
      ],
      # TODO(jrobbins): should be "Web-Facing Change PSA".
      [('Draft Intent to Ship email', INTENT_EMAIL_URL)],
      models.INTENT_EXPERIMENT, models.INTENT_SHIP),
