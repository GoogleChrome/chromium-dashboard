...
test('Demo 4: DevRel Grace Period Bypass & Owner Revert Banner', async ({ page, request }) => {
  ...
  test.setTimeout(150000); // Give a generous 150s runway for live LLM generation, bypass entries, and owner reverts!
  ...
  console.log('[Demo 4] Step 5: Entering bypass justification');
