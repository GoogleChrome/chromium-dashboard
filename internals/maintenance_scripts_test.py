...
class GenerateReviewActivityFileTest(testing_config.CustomTestCase):  # noqa: D101
    def setUp(self):  # noqa: D102
        ...
        self.activity_11 = Activity(
            ...
            feature_id=2,
            gate_id=13,
            author='user4@example.com',  # noqa: E501
...
class GenerateStaleFeaturesFileTest(testing_config.CustomTestCase):
    ...
    def setUp(self):  # noqa: D102
        ...
        )  # <-- Now an exclusion case  # noqa: E501
        self.feature_2.put()
        self.stage_2 = Stage(
            id=102,
            feature_id=2,
    ...
    def test_get_template_data__end_to_end(
        ...
        """Should correctly orchestrate the entire file generation process for both files."""  # noqa: E501
        mock_datetime.now.return_value = datetime.now()
        mock_datetime.side_effect = lambda *args, **kw: datetime(*args, **kw)
    ...
    def test_write_csv(self):
        ...
        def blob_side_effect(filename):
            if 'features.csv' in filename:
                return mock_blob_features  # noqa: E701
            if 'owners.csv' in filename:
                return mock_blob_owners  # noqa: E701
            if 'missing-criteria.csv' in filename:
                return mock_blob_missing  # noqa: E701
            return mock.MagicMock()
...
class ResetOutstandingNotificationsTest(testing_config.CustomTestCase):
    ...
    def test_get_template_data__resets_counters_and_ignores_others(
        ...
        # This feature should have been untouched and its counter should still be None.  # noqa: E501
...
class ResetStaleShippingMilestonesTest(testing_config.CustomTestCase):
    ...
    def setUp(self):  # noqa: D102
        ...
        #    EXPECTED: Feature notifications reset. Stage milestones reset. Activity created.  # noqa: E501
        ...
        #    EXPECTED: Feature notifications reset. Stage milestone NOT reset. No Activity.  # noqa: E501
        ...
        # 9. Stale feature (notifications=5) with MIXED milestones (in and out of range).  # noqa: E501
        #    EXPECTED: Feature notifications reset. One milestone reset. Activity created.  # noqa: E501
    ...
    def test_get_template_data__resets_stale_features_and_milestones_in_range(
        ...
        self.assertEqual(
            'Shipping/Rollout milestones were unset due to failure to verify accuracy.',  # noqa: E501
            act_201.content,
        )
