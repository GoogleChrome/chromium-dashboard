...
"""Tests for AI prompt templates, verifying correct rendering of gap analysis.

and spec synthesis templates.
"""
...
test_app = Flask(__name__, template_folder=settings.get_flask_template_path())
...
class TestAIPromptTemplatesHandler(unittest.TestCase):
    ...
    def test_prompt__spec_synthesis(self):
        ...
        self.render_and_verify(
            'prompts/spec-synthesis.html', data, 'spec-synthesis.html'
        )
    ...
    def test_prompt__test_analysis(self):
        ...
        self.render_and_verify(
            'prompts/test-analysis.html', data, 'test-analysis.html'
        )
    ...
    def test_prompt__gap_analysis(self):
        ...
        self.render_and_verify(
            'prompts/gap-analysis.html', data, 'gap-analysis.html'
        )
