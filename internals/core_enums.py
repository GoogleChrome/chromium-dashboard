...
INTENT_STAGES_BY_STAGE = {
    ...
    STAGE_BLINK_ORIGIN_TRIAL: INTENT_EXTEND_TRIAL,  # Separate intent for extension?
    STAGE_BLINK_EXTEND_ORIGIN_TRIAL: INTENT_EXTEND_TRIAL,
    STAGE_BLINK_SHIPPING: INTENT_SHIP,
    STAGE_BLINK_SHIPPED: INTENT_SHIPPED,
    ...
    STAGE_FAST_SHIPPED: INTENT_SHIPPED,

    STAGE_PSA_IMPLEMENT: INTENT_IMPLEMENT,
    STAGE_PSA_DEV_TRIAL: INTENT_EXPERIMENT,
    STAGE_PSA_SHIPPING: INTENT_SHIP,
    STAGE_PSA_SHIPPED: INTENT_SHIPPED,

    STAGE_DEP_PLAN: INTENT_INCUBATE,  # No intent in planning phase?
...
STAGES_AND_GATES_BY_FEATURE_TYPE: dict[int, list[tuple[int, Optional[int]]]] = {
    ...
    FEATURE_TYPE_EXISTING_ID: [
        ...
        (STAGE_FAST_SHIPPED, None)],
    FEATURE_TYPE_CODE_CHANGE_ID: [
        (STAGE_PSA_IMPLEMENT, GATE_PROTOTYPE),
        (STAGE_PSA_DEV_TRIAL, None),
        (STAGE_PSA_SHIPPING, GATE_SHIP),
        (STAGE_PSA_SHIPPED, None)],
