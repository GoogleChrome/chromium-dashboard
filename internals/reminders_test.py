...
from internals import core_enums, reminders
...
def make_test_features():
    ...
    for stage_type in stages:
        stage = Stage(
            id=(stage_type + 1),
            feature_id=feature_1.key.integer_id(),
    ...
    feature_3 = FeatureEntry(
        id=3, name='feature three', summary='sum', category=1, feature_type=2
    )
    feature_3.put()
    stages = [320, 330, 360]
    for stage_type in stages:
        stage = Stage(
            id=(stage_type + 3),
            feature_id=feature_3.key.integer_id(),
            stage_type=stage_type,
        )
        stage.put()
...
class FunctionTest(testing_config.CustomTestCase):
    def setUp(self):
        ...
        self.feature_template = FeatureEntry(
            id=123,
            name='feature one',
            summary='sum',
        ...
        for stage_type in stages:
            ...
            if stage_type == 150:
                stage.milestones = MilestoneSet(
                    desktop_first=100, desktop_last=105
                )
            # OT extension stage.
            if stage_type == 151:
        ...
        self.owner_user_pref = UserPref(
            email='feature_owner@example.com', notify_as_starrer=False
        )
        self.owner_user_pref.put()
        owner_user_pref_1 = UserPref(
            email='owner_1@example.com', notify_as_starrer=False
        )
        owner_user_pref_1.put()
        owner_user_pref_2 = UserPref(
            email='owner_2@example.com', notify_as_starrer=False
        )
    ...
    def test_build_email_tasks_feature_accuracy(self):
        ...
        with test_app.app_context():
            ...
            actual = reminders.build_email_tasks(
                ...
                '[Action Required] Verify important information about '
                'your shipping feature  (%s)',
        ...
        self.assertEqual(
            '[Action Required] Verify important information about '
            'your shipping feature  (feature one)',
            task['subject'],
        )
        self.assertEqual(None, task['reply_to'])
        # TESTDATA.make_golden(
        #     task['html'], 'test_build_email_tasks_feature_accuracy.html'
        # )
    ...
    def test_build_email_tasks_feature_accuracy__enterprise(self):
        ...
        # TESTDATA.make_golden(
        #     task['html'],
        #     'test_build_email_tasks_feature_accuracy_enterprise.html'
        # )
        self.assertMultiLineEqual(
    ...
    def test_build_email_tasks_feature_accuracy__escalated(self):
        ...
        task = actual[0]
        self.assertEqual(
            'ESCALATED: [Action Required] Verify important information '
            'about your shipping feature (feature one)',
            task['subject'],
        )
        self.assertEqual(None, task['reply_to'])
        # TESTDATA.make_golden(
        #     task['html'],
        #     'test_build_email_tasks_escalated_feature_accuracy.html'
        # )
        self.assertMultiLineEqual(
    ...
    def test_build_email_tasks_prepublication(self):
        ...
        self.assertEqual(None, task['reply_to'])
        # TESTDATA.make_golden(
        #     task['html'], 'test_build_email_tasks_prepublication.html'
        # )
        self.assertMultiLineEqual(
...
class SLOOverdueHandlerTest(testing_config.CustomTestCase):
    ...
    def test_build_gate_email_tasks__initial_due(self):
        ...
        self.assertEqual(None, task['reply_to'])
        # TESTDATA.make_golden(
        #     task['html'], 'test_build_gate_email_tasks__initial_due.html'
        # )
        self.assertEqual(
    ...
    def test_build_gate_email_tasks__initial_overdue(self):
        ...
        self.assertEqual(None, task['reply_to'])
        # TESTDATA.make_golden(
        #     task['html'], 'test_build_gate_email_tasks__initial_overdue.html'
        # )
        self.assertEqual(
    ...
    def test_build_gate_email_tasks__resolution_due(self):
        ...
        self.assertEqual(None, task['reply_to'])
        # TESTDATA.make_golden(
        #     task['html'], 'test_build_gate_email_tasks__resolution_due.html'
        # )
        self.assertEqual(
    ...
    def test_build_gate_email_tasks__resolution_overdue(self):
        ...
        # TESTDATA.make_golden(
        #     task['html'],
        #     'test_build_gate_email_tasks__resolution_overdue.html'
        # )
        self.assertEqual(
