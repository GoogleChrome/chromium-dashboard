...
class FeatureCreateTest(testing_config.CustomTestCase):
    ...
    @mock.patch(
        'internals.notifier_helpers.notify_subscribers_and_save_amendments'
    )
    def test_post__normal_valid(self, mock_notify):
        ...
        self.assertEqual(
            ['devrel-chromestatus-all@google.com'], feature_entry.devrel_emails
        )
        self.assertEqual(
    ...
    def test_post__feature_impact_missing_first_notice(
        ...
        self.assertEqual('user1@google.com', feature_entry.creator_email)
        self.assertEqual(
            120, feature_entry.first_enterprise_notification_milestone
        )
    ...
    def test_post__enterprise_impact_with_first_notice(
        ...
        self.assertEqual('user1@google.com', feature_entry.creator_email)
        self.assertEqual(
            100, feature_entry.first_enterprise_notification_milestone
        )
    ...
    def test_post__enterprise_impact_with_old_first_notice(
        ...
        self.assertEqual('user1@google.com', feature_entry.creator_email)
        self.assertEqual(
            101, feature_entry.first_enterprise_notification_milestone
        )
