...
(function (exports) {
    ...
    class ChromeStatusClient {
        ...
        ensureTokenIsValid() {
            return __awaiter(this, void 0, void 0, function* () {
                if (ChromeStatusClient.isTokenExpired(this.tokenExpiresSec)) {
                    const refreshResponse = yield this.doFetch('/currentuser/token', 'POST', null);
        ...
        doFetch(resource_1, httpMethod_1, body_1) {
            return __awaiter(this, arguments, void 0, function* (resource, httpMethod, body, includeToken = true) {
                ...
                if (response.status !== 200) {
                    throw new ChromeStatusHttpError(`Got error response from server ${resource}: ${response.status}`, resource, httpMethod, response.status);
                }
                const rawResponseText = yield response.text();
                const XSSIPrefix = ')]}\'\n';
                if (!rawResponseText.startsWith(XSSIPrefix)) {
                    throw new Error(`Response does not start with XSSI prefix: ${XSSIPrefix}`);
                }
        ...
        setVote(featureId, gateId, state) {
            return this.doPost(`/features/${featureId}/votes/${gateId}`, { state: Number(state) });
        }
        getGates(featureId) {
        ...
        postComment(featureId, gateId, comment, postToThreadType) {
            if (gateId) {
                return this.doPost(`/features/${featureId}/approvals/${gateId}/comments`, { comment, postToThreadType });
            }
            else {
                return this.doPost(`/features/${featureId}/approvals/comments`, { comment, postToThreadType });
            }
        }
        deleteComment(featureId, commentId) {
            return this.doPatch(`/features/${featureId}/approvals/comments`, { commentId, isUndelete: false });
        }
        undeleteComment(featureId, commentId) {
            return this.doPatch(`/features/${featureId}/approvals/comments`, { commentId, isUndelete: true });
        }
        // Features API
        ...
        getFeaturesInMilestone(milestone) {
            return __awaiter(this, void 0, void 0, function* () {
                return this.doGet(`/features?milestone=${milestone}`).then((resp) => resp['features_by_type']);
            });
        }
        ...
        searchFeatures(userQuery, showEnterprise, sortSpec, start, num) {
            return __awaiter(this, void 0, void 0, function* () {
         ...
         */
        getFeatureLinks(featureId_1) {
            return __awaiter(this, arguments, void 0, function* (featureId, updateStaleLinks = true) {
        ...
        createOriginTrial(featureId, stageId, body) {
            return __awaiter(this, void 0, void 0, function* () {
                return this.doPost(`/origintrials/${featureId}/${stageId}/create`, body);
            });
        }
        extendOriginTrial(featureId, stageId, body) {
            return __awaiter(this, void 0, void 0, function* () {
