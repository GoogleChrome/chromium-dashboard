...
class ChromedashTimeline extends LitElement {
    ...
    drawVisualization(data, bucketId, showAllHistoricalData) {
        ...
        const groupedTable = window.google.visualization.data.group(datatable, [{ column: 0, modifier: aggregateByMonth, type: 'date' }], [
            {
                column: 1,
