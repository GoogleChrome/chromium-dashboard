...
function enhanceGithubIssueLink(featureLink, text) {
  ...
  >
    <sl-tooltip style="--sl-tooltip-arrow-size: 0;--max-width: 50vw;">
      ...
      <sl-tag>
        <img
          src=${(_a = externalReviewer === null || externalReviewer === void 0 ? void 0 : externalReviewer.icon) !== null && _a !== void 0 ? _a : 'https://docs.github.com/assets/cb-600/images/site/favicon.png'}
          alt="icon"
          class="icon"
        />
...
export function enhanceUrl(url, featureLinks = [], fallback, text) {
    ...
    >${text !== null && text !== void 0 ? text : url}</chromedash-link
  >`;
}
// prettier-ignore
