 ...
 * Firefox, and Safari. */
var ExternalReviewer = /** @class */ (function () {
    /** @private
     * @param {string} icon
     * @param {Record<string, LabelInfo>} labels
     */
    function ExternalReviewer(icon, labels) {
     ...
     * reviewers.
     */
    ExternalReviewer.get = function (repo) {
        switch (repo) {
            case 'mozilla/standards-positions':
                return new ExternalReviewer('https://avatars.githubusercontent.com/u/131524?s=48&v=4', {
            ...
            case 'WebKit/standards-positions':
                return new ExternalReviewer('https://avatars.githubusercontent.com/u/6458?s=48&v=4', {
            ...
            case 'w3ctag/design-reviews':
                return new ExternalReviewer('https://avatars.githubusercontent.com/u/3874462?s=48&v=4', {
     ...
     * @returns {LabelInfo}
     */
    ExternalReviewer.prototype.label = function (name) {
        return this._labels[name];
    };
    return ExternalReviewer;
}());
export { ExternalReviewer };
//# sourceMappingURL=external-reviewers.js.map