...
"""Unit tests for the xsrf module tests the generation of XSRF tokens, proper
validation of valid and malformed tokens, and token expiration logic.
"""
...
class XsrfTest(testing_config.CustomTestCase):
    ...
    def test_generate_token__distinct(self):
        ...
        self.assertNotEqual(
            xsrf.generate_token('user1@example.com'), xsrf.generate_token(None)
        )
    ...
    def test_validate_token__malformed_token(self):
        ...
        with self.assertRaises(xsrf.TokenIncorrect):
            xsrf.validate_token(
                '098a08fe08b08c08a05e:9721973123', 'user1@example.com'
            )
