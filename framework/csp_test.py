...
class CspTest(unittest.TestCase):
    ...
    def test_get_default_policy__strict(self):
        ...
        self.assertCountEqual(
            list(csp.DEFAULT_POLICY.keys()), list(policy.keys())
        )
    ...
    def test_get_default_policy__strict_two(self):
        ...
        policy = csp.get_default_policy(nonce='12345')
        self.assertCountEqual(
            list(csp.NONCE_ONLY_POLICY.keys()), list(policy.keys())
        )  # noqa: E501
    ...
    def test_get_csp_header_key__enforced(self):
        ...
        self.assertEqual(csp.HEADER_KEY_ENFORCE, csp.get_csp_header_key())
    ...
    def test_get_csp_header_key__enforced_two(self):
        ...
        self.assertEqual(csp.HEADER_KEY_REPORT_ONLY, csp.get_csp_header_key())
