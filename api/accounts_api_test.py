...
"""Tests for the accounts_api module.

Verifying account creation and permission handling.
"""
...
class AccountsAPITest(testing_config.CustomTestCase):
    ...
    def test_create__normal_valid(self):
        ...
        new_appuser = user_models.AppUser.query(
            user_models.AppUser.email == 'new_user@example.com'
        ).get()
    ...
    def test_create__site_editor_valid(self):
        ...
        new_appuser = user_models.AppUser.query(
            user_models.AppUser.email == 'new_site_editor@example.com'
        ).get()
    ...
    def test_create__admin_valid(self):
        ...
        new_appuser = user_models.AppUser.query(
            user_models.AppUser.email == 'new_admin@example.com'
        ).get()
    ...
    def test_create__forbidden(self):
        ...
        new_appuser = user_models.AppUser.query(
            user_models.AppUser.email == 'new@example.com'
        ).get()
