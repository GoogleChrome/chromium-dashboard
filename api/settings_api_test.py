...
"""Tests for the settings_api module.

Verifying the storage and retrieval of user preferences.
"""
...
class SettingsAPITest(testing_config.CustomTestCase):
    ...
    def test_post__valid(self):
        ...
        with test_app.test_request_context('/notify', json={'notify': True}):
    ...
    def test_post__invalid(self):
        ...
        with test_app.test_request_context('/notify', json={'notify': 'xyz'}):
