...
class CommentsConvertersTest(testing_config.CustomTestCase):
    def test_amendment_to_OAM__normal(self):
        ...
        amend = Amendment(
            field_name='summary', old_value='old', new_value='[new,fresh]'
        )
...
class CommentsAPITest(testing_config.CustomTestCase):
    def setUp(self):
        ...
        self.gate_1 = Gate(
            feature_id=self.feature_id, stage_id=1, gate_type=2, state=Vote.NA
        )
        self.gate_1.put()
    ...
    def test_get__all_some(self):
        ...
        self.assertEqual(self.expected_1, actual_comment)
    ...
    def test_patch__delete_comment(self):
        """Handler marks a comment as deleted as requested by authorized
        user."""
        self.act_1_1.put()
