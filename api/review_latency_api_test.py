...
"""Tests for the review_latency_api module, verifying the calculation and
sorting of review latencies."""
    ...
    def test_do_get__sorting(self):
        ...
        expected = [
            ...
            },
            {
                'feature': {'name': 'Feature one', 'id': self.fe_1_id},
                'gate_reviews': [
                    {'gate_type': 1, 'latency_days': 1},
                    {'gate_type': 2, 'latency_days': 0},
                    {
                        'gate_type': 3,
                        'latency_days': review_latency_api.NOT_STARTED_LATENCY,
                    },
