...
class StagesAPITest(testing_config.CustomTestCase):
    ...
    def setUp(self):
        ...
        self.fe = FeatureEntry(
            ...
            name='feature one',
            summary='summary',
            owner_emails=[self.feature_owner.email],
            feature_type=0,
            category=1,
        )
        self.fe.put()
        ...
        # Shipping stage.
        self.stage_2 = Stage(
            id=11, feature_id=1, stage_type=160, created=self.now
        )
        self.stage_2.put()
        ...
        self.stage_6 = Stage(
            id=60, feature_id=1, stage_type=1061, browser='Chrome'
        )
        self.stage_6.put()
    ...
    def test_post__bad_id(self, mock_abort):
        ...
        mock_abort.assert_called_once_with(
            404, description='FeatureEntry 3001 not found.'
        )
    ...
    def test_post__gate_created(self):
        ...
        testing_config.sign_in('feature_owner@example.com', 123)
        json = {'stage_type': {'form_field_name': 'stage_type', 'value': 151}}
    ...
    def test_patch__valid(self, mock_dkwp):
        ...
        self.assertEqual(
            stage.intent_thread_url, 'https://example.com/different'
        )
    ...
    def test_patch__ot_creation(
        self, mock_send_ot_creation_notification, mock_dkwp
    ):
        """A valid PATCH request should update an existing stage."""
        testing_config.sign_in('feature_owner@example.com', 123)
