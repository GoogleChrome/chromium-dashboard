...
class StaleFeaturesAPITest(testing_config.CustomTestCase):  # noqa: D101
    def setUp(self):
    ...
    def test_do_get__success(self, mock_get_stale_features):
        ...
        self.assertEqual(
            feature_1_info['outstanding_notifications'],
            self.feature_1.outstanding_notifications,
        )
        self.assertEqual(
            feature_1_info['accurate_as_of'], '2025-10-01T12:30:00'
        )
        ...
        self.assertEqual(
            feature_2_info['accurate_as_of'], '2025-09-15T00:00:00'
        )
