...
export const QUERIABLE_FIELDS = [
  ...
  {name: 'tags', kind: TEXT_KIND,
    doc: 'Search tags for finding feature entries'},
  {name: 'owner', kind: EMAIL_KIND,
    doc: 'One of the feature owners'},
  ...
  {name: 'browsers.chrome.devrel', kind: EMAIL_KIND,
    doc: 'Developer relations contact',
  },

  //  'browsers.chrome.status': Feature.impl_status_chrome,
  {name: 'browsers.chrome.desktop', kind: MILESTONE_KIND,
    doc: 'Desktop shipping milestone',
  },
  {name: 'browsers.chrome.android', kind: MILESTONE_KIND,
    doc: 'Android shipping milestone',
  },
  {name: 'browsers.chrome.ios', kind: MILESTONE_KIND,
    doc: 'iOS shipping milestone',
  },
  {name: 'browsers.chrome.webview', kind: MILESTONE_KIND,
    doc: 'Webview shipping milestone',
  },
  // 'requires_embedder_support': Feature.requires_embedder_support,

  {name: 'browsers.chrome.flag_name', kind: TEXT_KIND,
    doc: 'Flag name that allows developers to enable the feature',
  },
  {name: 'browsers.chrome.finch_name', kind: TEXT_KIND,
    doc: 'Finch name',
  },
  ...
  // 'wpt': Feature.wpt,
  {name: 'browsers.chrome.devtrial.desktop.start', kind: MILESTONE_KIND,
    doc: 'Desktop DevTrial start',
  },
  {name: 'browsers.chrome.devtrial.android.start', kind: MILESTONE_KIND,
    doc: 'Android DevTrial start',
  },
  {name: 'browsers.chrome.devtrial.ios.start', kind: MILESTONE_KIND,
    doc: 'iOS DevTrial start',
  },
  {name: 'browsers.chrome.devtrial.webview.start', kind: MILESTONE_KIND,
  ...
  {name: 'browsers.chrome.ot.desktop.start', kind: MILESTONE_KIND,
    doc: 'Desktop Origin Trial start',
  },
  {name: 'browsers.chrome.ot.desktop.end', kind: MILESTONE_KIND,
    doc: 'Desktop Origin Trial end',
  },
  {name: 'browsers.chrome.ot.android.start', kind: MILESTONE_KIND,
    doc: 'Android Origin Trial start',
  },
  {name: 'browsers.chrome.ot.android.end', kind: MILESTONE_KIND,
    doc: 'Android Origin Trial end',
  },
  {name: 'browsers.chrome.ot.webview.start', kind: MILESTONE_KIND,
    doc: 'WebView Origin Trial start',
  },
  {name: 'browsers.chrome.ot.webview.end', kind: MILESTONE_KIND,
  ...
  {name: 'category', kind: ENUM_KIND,
    doc: 'Feature category',
    choices: FEATURE_CATEGORIES,
  },
  {name: 'feature_type', kind: ENUM_KIND,
    doc: 'Feature type',
    choices: FEATURE_TYPES,
  },
  {name: 'impl_status_chrome', kind: ENUM_KIND,
    doc: 'Implementation status',
    choices: IMPLEMENTATION_STATUS,
  },
  {name: 'intent_stage', kind: ENUM_KIND,
    doc: 'Spec process stage',
    choices: INTENT_STAGES,
  },
  {name: 'rollout_impact', kind: ENUM_KIND,
    doc: 'Impact',
  ...
  // },
  {name: 'security_review_status', kind: ENUM_KIND,
    doc: 'Security review status',
    choices: REVIEW_STATUS_CHOICES,
  },
  {name: 'privacy_review_status', kind: ENUM_KIND,
    doc: 'Privacy review status',
    choices: REVIEW_STATUS_CHOICES,
  },
  {name: 'tag_review_status', kind: ENUM_KIND,
    doc: 'TAG Specification Review Status',
    choices: REVIEW_STATUS_CHOICES,
  },
  {name: 'browsers.safari.view', kind: ENUM_KIND,
    doc: 'Safari views',
    choices: VENDOR_VIEWS_COMMON,
  },
  {name: 'browsers.ff.view', kind: ENUM_KIND,
    doc: 'Firefox views',
    choices: VENDOR_VIEWS_GECKO,
  },
  {name: 'browsers.webdev.view', kind: ENUM_KIND,
