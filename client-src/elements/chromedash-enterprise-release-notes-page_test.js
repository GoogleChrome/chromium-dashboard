  ...
  it('renders detailed release with features in the right sections', async () => {
    ...
    // Test Chrome browser updates
    {
      ...
      // Test feature 1
      {
        ...
        assert.equal(
          '< To remove - Feature details - Owners: owner1 - Editors: editor1  - Last Updated: feature 4 updated >',
      ...
      // Test feature 2
      {
        ...
        assert.equal(
          '< To remove - Feature details - Owners: owner - Editors: editor1, editor2  - Last Updated: updated when >',
