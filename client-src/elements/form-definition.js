...
export const STAGE_FORMS = {
  [INCUBATE_ID]: {
    [INTENT_STAGES[INCUBATE_ID].INTENT_INCUBATE[0]]: NEWFEATURE_INCUBATE,
    [INTENT_STAGES[INCUBATE_ID].INTENT_IMPLEMENT[0]]: NEWFEATURE_PROTOTYPE,
    [INTENT_STAGES[INCUBATE_ID].INTENT_EXPERIMENT[0]]: ANY_DEVTRIAL,
    [INTENT_STAGES[INCUBATE_ID].INTENT_IMPLEMENT_SHIP[0]]: NEWFEATURE_EVALREADINESSTOSHIP,
    [INTENT_STAGES[INCUBATE_ID].INTENT_EXTEND_TRIAL[0]]: NEWFEATURE_ORIGINTRIAL,
    [INTENT_STAGES[INCUBATE_ID].INTENT_SHIP[0]]: MOST_PREPARETOSHIP,
    [INTENT_STAGES[INCUBATE_ID].INTENT_ROLLOUT[0]]: ENTERPRISE_PREPARE_TO_SHIP,
    [INTENT_STAGES[INCUBATE_ID].INTENT_SHIPPED[0]]: ANY_SHIP,
  },

  [EXISTING_ID]: {
    [INTENT_STAGES[EXISTING_ID].INTENT_IMPLEMENT[0]]: EXISTING_PROTOTYPE,
    [INTENT_STAGES[EXISTING_ID].INTENT_EXPERIMENT[0]]: ANY_DEVTRIAL,
    [INTENT_STAGES[EXISTING_ID].INTENT_EXTEND_TRIAL[0]]: EXISTING_ORIGINTRIAL,
    [INTENT_STAGES[EXISTING_ID].INTENT_SHIP[0]]: MOST_PREPARETOSHIP,
    [INTENT_STAGES[EXISTING_ID].INTENT_ROLLOUT[0]]: ENTERPRISE_PREPARE_TO_SHIP,
    [INTENT_STAGES[EXISTING_ID].INTENT_SHIPPED[0]]: ANY_SHIP,
  },

  [CODE_CHANGE_ID]: {
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_IMPLEMENT[0]]: PSA_IMPLEMENT,
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_EXPERIMENT[0]]: ANY_DEVTRIAL,
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_SHIP[0]]: PAS_PREPARETOSHIP,
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_ROLLOUT[0]]: ENTERPRISE_PREPARE_TO_SHIP,
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_SHIPPED[0]]: ANY_SHIP,
  },

  [DEPRECATION_ID]: {
    [INTENT_STAGES[DEPRECATION_ID].INTENT_IMPLEMENT[0]]: DEPRECATION_IMPLEMENT,
    [INTENT_STAGES[DEPRECATION_ID].INTENT_EXPERIMENT[0]]: ANY_DEVTRIAL,
    [INTENT_STAGES[DEPRECATION_ID].INTENT_EXTEND_TRIAL[0]]: DEPRECATION_DEPRECATIONTRIAL,
    [INTENT_STAGES[DEPRECATION_ID].INTENT_SHIP[0]]: DEPRECATION_PREPARETOSHIP,
    [INTENT_STAGES[DEPRECATION_ID].INTENT_ROLLOUT[0]]: ENTERPRISE_PREPARE_TO_SHIP,
    [INTENT_STAGES[DEPRECATION_ID].INTENT_REMOVED[0]]: DEPRECATION_REMOVED,
  },

  [ENTERPRISE_ID]: {
    [INTENT_STAGES[ENTERPRISE_ID].INTENT_ROLLOUT[0]]: ENTERPRISE_PREPARE_TO_SHIP,
  },
};

export const IMPL_STATUS_FORMS = {
  [INCUBATE_ID]: {
    [INTENT_STAGES[INCUBATE_ID].INTENT_INCUBATE[0]]: ['', IMPLSTATUS_INCUBATE],
    [INTENT_STAGES[INCUBATE_ID].INTENT_EXPERIMENT[0]]:
      [IMPLEMENTATION_STATUS.BEHIND_A_FLAG[0], IMPLSTATUS_DEVTRIAL],
    [INTENT_STAGES[INCUBATE_ID].INTENT_EXTEND_TRIAL[0]]:
      [IMPLEMENTATION_STATUS.ORIGIN_TRIAL[0], IMPLSTATUS_ORIGINTRIAL],
    [INTENT_STAGES[INCUBATE_ID].INTENT_IMPLEMENT_SHIP[0]]:
      ['', IMPLSTATUS_EVALREADINESSTOSHIP],
    [INTENT_STAGES[INCUBATE_ID].INTENT_SHIP[0]]:
      [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[INCUBATE_ID].INTENT_ROLLOUT[0]]:
        [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[INCUBATE_ID].INTENT_SHIPPED[0]]:
      [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[INCUBATE_ID].INTENT_REMOVED[0]]:
      [IMPLEMENTATION_STATUS.REMOVED[0], IMPLSTATUS_ALLMILESTONES],
  },
  [EXISTING_ID]: {
    [INTENT_STAGES[EXISTING_ID].INTENT_EXPERIMENT[0]]:
      [IMPLEMENTATION_STATUS.BEHIND_A_FLAG[0], IMPLSTATUS_DEVTRIAL],
    [INTENT_STAGES[EXISTING_ID].INTENT_EXTEND_TRIAL[0]]:
      [IMPLEMENTATION_STATUS.ORIGIN_TRIAL[0], IMPLSTATUS_ORIGINTRIAL],
    [INTENT_STAGES[EXISTING_ID].INTENT_SHIP[0]]:
      [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[EXISTING_ID].INTENT_ROLLOUT[0]]:
        [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[EXISTING_ID].INTENT_SHIPPED[0]]:
      [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[EXISTING_ID].INTENT_REMOVED[0]]:
      [IMPLEMENTATION_STATUS.REMOVED[0], IMPLSTATUS_ALLMILESTONES],
  },
  [CODE_CHANGE_ID]: {
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_EXPERIMENT[0]]:
      [IMPLEMENTATION_STATUS.BEHIND_A_FLAG[0], IMPLSTATUS_DEVTRIAL],
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_SHIP[0]]:
      [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_ROLLOUT[0]]:
        [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_SHIPPED[0]]:
      [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[CODE_CHANGE_ID].INTENT_REMOVED[0]]:
      [IMPLEMENTATION_STATUS.REMOVED[0], IMPLSTATUS_ALLMILESTONES],
  },
  [DEPRECATION_ID]: {
    [INTENT_STAGES[DEPRECATION_ID].INTENT_EXPERIMENT[0]]:
      [IMPLEMENTATION_STATUS.BEHIND_A_FLAG[0], IMPLSTATUS_DEVTRIAL],
    [INTENT_STAGES[DEPRECATION_ID].INTENT_EXTEND_TRIAL[0]]:
      [IMPLEMENTATION_STATUS.ORIGIN_TRIAL[0], IMPLSTATUS_ORIGINTRIAL],
    [INTENT_STAGES[DEPRECATION_ID].INTENT_SHIP[0]]:
      [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[DEPRECATION_ID].INTENT_ROLLOUT[0]]:
        [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[DEPRECATION_ID].INTENT_SHIPPED[0]]:
      [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
    [INTENT_STAGES[DEPRECATION_ID].INTENT_REMOVED[0]]:
      [IMPLEMENTATION_STATUS.REMOVED[0], IMPLSTATUS_ALLMILESTONES],
  },
  [ENTERPRISE_ID]: {
    [INTENT_STAGES[ENTERPRISE_ID].INTENT_ROLLOUT[0]]:
        [IMPLEMENTATION_STATUS.ENABLED_BY_DEFAULT[0], IMPLSTATUS_ALLMILESTONES],
  },
};
