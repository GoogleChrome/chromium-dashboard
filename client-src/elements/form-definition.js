...
export const FLAT_FORMS_BY_FEATURE_TYPE = {
  ...
  [FEATURE_TYPES.FEATURE_TYPE_CODE_CHANGE_ID[0]]: [
    FLAT_METADATA_FIELDS,
    PSA_IMPLEMENT_FIELDS,
    FLAT_DEV_TRIAL_FIELDS,
    PSA_PREPARE_TO_SHIP_FIELDS,
  ],
  [FEATURE_TYPES.FEATURE_TYPE_DEPRECATION_ID[0]]: [
    FLAT_METADATA_FIELDS,
    FLAT_DEV_TRIAL_FIELDS,
    DEPRECATION_ORIGIN_TRIAL_FIELDS,
    DEPRECATION_PREPARE_TO_SHIP_FIELDS,
  ],
...
const FLAT_STAGE_FORMS = {
  ...
  [INTENT_STAGES.INTENT_IMPLEMENT[0]]: FLAT_PROTOTYPE_FIELDS,
...
export const STAGE_FORMS = {
  ...
  [FEATURE_TYPES.FEATURE_TYPE_CODE_CHANGE_ID[0]]: {
    [INTENT_STAGES.INTENT_IMPLEMENT[0]]: PSA_IMPLEMENT_FIELDS,
    [INTENT_STAGES.INTENT_EXPERIMENT[0]]: FLAT_DEV_TRIAL_FIELDS,
    [INTENT_STAGES.INTENT_SHIP[0]]: PSA_PREPARE_TO_SHIP_FIELDS,
    [INTENT_STAGES.INTENT_ROLLOUT[0]]: FLAT_ENTERPRISE_PREPARE_TO_SHIP_FIELDS,
    [INTENT_STAGES.INTENT_SHIPPED[0]]: FLAT_PREPARE_TO_SHIP_FIELDS,
  },
  ...
  [FEATURE_TYPES.FEATURE_TYPE_DEPRECATION_ID[0]]: {
    [INTENT_STAGES.INTENT_EXPERIMENT[0]]: FLAT_DEV_TRIAL_FIELDS,
    [INTENT_STAGES.INTENT_EXTEND_TRIAL[0]]: DEPRECATION_ORIGIN_TRIAL_FIELDS,
    [INTENT_STAGES.INTENT_SHIP[0]]: DEPRECATION_PREPARE_TO_SHIP_FIELDS,
    [INTENT_STAGES.INTENT_ROLLOUT[0]]: FLAT_ENTERPRISE_PREPARE_TO_SHIP_FIELDS,
  },
