...
export class ExternalReviewer {
  ...
  static get(repo) {
    switch (repo) {
      case 'mozilla/standards-positions': return new ExternalReviewer(
        'https://avatars.githubusercontent.com/u/131524?s=48&v=4',
        {
          ...
          'position: under consideration': {description: 'Under Consideration', variant: 'neutral'},
        });

      case 'WebKit/standards-positions': return new ExternalReviewer(
      ...
      case 'w3ctag/design-reviews': return new ExternalReviewer(
        'https://avatars.githubusercontent.com/u/3874462?s=48&v=4',
        {
          'Resolution: ambivalent': {description: 'Ambivalent', variant: 'neutral'},
          'Resolution: decline': {description: 'Decline', variant: 'neutral'},
          'Resolution: lack of consensus': {description: 'Lack of Consensus', variant: 'neutral'},
          'Resolution: object': {description: 'Object', variant: 'danger'},
          'Resolution: out of scope': {description: 'Out of Scope', variant: 'neutral'},
          'Resolution: overtaken': {description: 'Overtaken', variant: 'warning'},
          'Resolution: satisfied with concerns': {
            description: 'Satisfied with Concerns', variant: 'warning',
          },
          'Resolution: satisfied': {description: 'Satisfied', variant: 'success'},
          'Resolution: timed out': {description: 'Timed Out', variant: 'warning'},
          'Resolution: too early': {description: 'Too Early', variant: 'warning'},
          'Resolution: unsatisfied': {description: 'Unsatisfied', variant: 'danger'},
          'Resolution: validated': {description: 'Early Review Validated', variant: 'warning'},
          'Resolution: withdrawn': {description: 'Withdrawn', variant: 'warning'},
        });
    }
    return undefined;
  }
