...
// import {ChromeDashIntentDialog, openIntentDialog} from './chromedash-intent-dialog';
...
// describe('chromedash-intent-dialog', () => {
...
//     it('should redirect anonymous user to login', async () => {
//         // testing_config.sign_out()
//         // feature_id = self.feature_1.key.integer_id()
//         // with test_app.test_request_context(self.request_path):
//         //   actual_response = self.handler.get_template_data(feature_id=feature_id)
...
//     it('should throw 404 if feature does not exist', async () => {
//         // testing_config.sign_in('user1@google.com', 123567890)
//         // bad_feature_id = self.feature_1.key.integer_id() + 1
//         // with test_app.test_request_context(self.request_path):
//         //   with self.assertRaises(werkzeug.exceptions.NotFound):
...
//     it('should preview intent email for a feature using an old URL', async () => {
//         // request_path = (
//         //     '/admin/features/launch/%d?intent' % self.feature_1.key.integer_id())
//         // testing_config.sign_in('user1@google.com', 123567890)
//         // feature_id = self.feature_1.key.integer_id()
...
//     it('should preview intent email for a feature', async () => {
//         // testing_config.sign_in('user1@google.com', 123567890)
//         // feature_id = self.feature_1.key.integer_id()
//         // with test_app.test_request_context(self.request_path):
//         //   actual_data = self.handler.get_template_data(feature_id=feature_id)
