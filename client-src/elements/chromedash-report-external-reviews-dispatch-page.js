  ...
  render() {
    return html`
      ...
      <ul>
        ...
        <li><a href="/reports/external_reviews/gecko">Gecko / Firefox / Mozilla</a></li>
        <li><a href="/reports/external_reviews/webkit">WebKit / Safari / Apple</a></li>
      </ul>
    `;
  }
}

customElements.define('chromedash-report-external-reviews-dispatch-page',
